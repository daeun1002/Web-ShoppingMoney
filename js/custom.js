...
// image slide
// function simg(str){
//     document.getElementById('bimg').src = 'images/'+str+'.jpg';
// }
...
function optChange(e){
    ...
    if(val != ""){
        switch(val){
            ...
            case 'jp14k' :
                for(let i in jp14k){
                    // console.log(jp14k[i].key, jp14k[i].val);
                    let opt = document.createElement('option');
            ...
            case 'jw14k' :
                for(let i in jw14k){
                    // console.log(jw14k[i].key, jw14k[i].val);
                    let opt = document.createElement('option');
            ...
            case 'jy18k' :
                for(let i in jw18k){
                    // console.log(jy18k[i].key, jy18k[i].val);
                    let opt = document.createElement('option');
            ...
            case 'jp18k' :
                for(let i in jp18k){
                    // console.log(jp18k[i].key, jp18k[i].val);
                    let opt = document.createElement('option');
            ...
            case 'jw18k' :
                for(let i in jw14k){
                    // console.log(jw18k[i].key, jw18k[i].val);
                    let opt = document.createElement('option');
...
function opt2Change(e){
    ...
    prTitle = `<div class="vbox">
               ...
               <div class="addbox">
                   <div class="addinput">
                       <input type="text" name="cot" value="1">
                   </div>
                   <div class="addbtn">
                       <div class="add btn"><i class="fa-solid fa-caret-up"></i></div>
                       <div class="sub btn"><i class="fa-solid fa-caret-down"></i></div>
                   </div>
               </div>
               <div class="prbox">
